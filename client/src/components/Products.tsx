...
const Products: React.FC = () => {
  ...
  const [styles, setStyles] = useState<string[]>([]); // New state for styles
  ...
  useEffect(() => {
    ...
    const fetchStyles = async () => {
      try {
        const res = await fetch('/styles.xml'); // Adjust path if needed
        ...
        setStyles(['']); // Fallback to empty option
      }
    };
    ...
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto', fontFamily: 'Arial, sans-serif' }}>
      ...
      >
        ...
        >
          ...
          {/* Other fields unchanged up to Class */}
